...
$CheckProfile6 = $GetProfileConfig[13] -replace 'Hunt_Profile_Name_6=', ''
$CheckProfile7 = $GetProfileConfig[14] -replace 'Hunt_Profile_Name_7=', ''
$CheckProfile8 = $GetProfileConfig[15] -replace 'Hunt_Profile_Name_8=', ''
$CheckProfile9 = $GetProfileConfig[16] -replace 'Hunt_Profile_Name_9=', ''
$CheckProfile10 = $GetProfileConfig[17] -replace 'Hunt_Profile_Name_10=', ''
...
if ($DetectionCount -match "3") { $ArchetypeForm.ClientSize = "94, 330" } elseif ($DetectionCount -match "2") { $ArchetypeForm.ClientSize = "94, 273" } elseif ($DetectionCount -match "1") { $ArchetypeForm.ClientSize = "94, 216" }
...
$ArchetypeForm.Add_Load({   
    ...
    if (Test-Path -Path "$PokeMMOWorkingDir\data\themes\$CurrentTheme\AC") { } else { $InsertInThemePath = "$PokeMMOWorkingDir\data\themes\$CurrentTheme\theme.xml"; $InsertInTheme = Get-Content -Path $InsertInThemePath; $InsertInThemeLine = $InsertInTheme.count; $InsertInTheme[$InsertInThemeLine-1] = '    <include filename="AC/1.0_Scaling.xml"/>
...
$ArchetypeMainEggImage.Width = 36
$ArchetypeMainEggImage.Height = 32
$ArchetypeMainEggImage.BackColor = [System.Drawing.ColorTranslator]::FromHtml($EggCountBGColor)
if ($DetectionCount -match "3") { $ArchetypeMainEggImage.location = New-object system.drawing.point(29,241) } elseif ($DetectionCount -match "2") { $ArchetypeMainEggImage.location = New-object system.drawing.point(29,185) } elseif ($DetectionCount -match "1") { $ArchetypeMainEggImage.location = New-object system.drawing.point(29,126) }
...
if ($DetectionCount -match "3") { $ArchetypeEggLabelCount.Location = New-object system.drawing.point(25,273) } elseif ($DetectionCount -match "2") { $ArchetypeEggLabelCount.Location = New-object system.drawing.point(25,217) } elseif ($DetectionCount -match "1") { $ArchetypeEggLabelCount.Location = New-object system.drawing.point(25,159) }
...
$ArchetypeEggLabelCount.Width = 44
...
if ($DetectionCount -match "3") { $ArchetypeCollapsedCount.Location = New-object system.drawing.point(25,217) } elseif ($DetectionCount -match "2") { $ArchetypeCollapsedCount.Location = New-object system.drawing.point(25,160) } elseif ($DetectionCount -match "1") { $ArchetypeCollapsedCount.Location = New-object system.drawing.point(25,103) }
...
$ArchetypeCollapsedCount.Width = 44
$ArchetypeCollapsedCount.Height = 12
...
$ArchetypePokeAImage.location = New-object system.drawing.point(29,45)
$ArchetypePokeAImage.Add_Click({
    ...
    if (($_.Button -eq [System.Windows.Forms.MouseButtons]::Right) -and ($PokemonA -match "Blank")) {
        ...
        if ($PokemonDexInput) { if ($GetPokemonID | Where-Object { $_ -match "\b$PokemonDexInput\b" }) { $SetConfig = "$PWD\Counter Config Files\CounterConfig_$GetProfile.txt"; $GetConfig = Get-Content $SetConfig; $GetConfig[8] = "Pokemon_A=$GetPokemonID"; $GetConfig[10] = "Pokemon_A_Hover=$GetPokemonName #$GetPokemonID"; $GetConfig | Set-Content -Path $SetConfig; Start-Process "$PWD\ArchetypeCounter.bat" -NoNewWindow -Wait } else { [System.Windows.MessageBox]::Show("No match found for the Pokemon Dex Number. Please ensure you input a correct number value for the specific Pokemon.","Archetype Counter","OK","Asterisk") } }
...
$ArchetypePokeALabelCount.Location = New-object system.drawing.point(25,77)
...
$ArchetypePokeBImage.Add_Click({
    ...
    if (($_.Button -eq [System.Windows.Forms.MouseButtons]::Right) -and ($PokemonB -match "Blank")) {
        ...
        $GetPokemonID = $GetPokemonWithIDFromFile -Replace '[^0-9]','' -Replace ' ', ''
        $GetPokemonName = $GetPokemonWithIDFromFile -Replace '[0-9]','' -Replace ' ', ''
        if ($PokemonDexInput) { if ($GetPokemonID | Where-Object { $_ -match "\b$PokemonDexInput\b" }) { $SetConfig = "$PWD\Counter Config Files\CounterConfig_$GetProfile.txt"; $GetConfig = Get-Content $SetConfig; $GetConfig[11] = "Pokemon_B=$GetPokemonID"; $GetConfig[13] = "Pokemon_B_Hover=$GetPokemonName #$GetPokemonID"; $GetConfig | Set-Content -Path $SetConfig; Start-Process "$PWD\ArchetypeCounter.bat" -NoNewWindow -Wait } else { [System.Windows.MessageBox]::Show("No match found for the Pokemon Dex Number. Please ensure you input a correct number value for the specific Pokemon.","Archetype Counter","OK","Asterisk") } }
...
$ArchetypePokeBLabelCount.Location = New-object system.drawing.point(25,134)
...
$ArchetypePokeCImage.Add_Click({
    ...
    if (($_.Button -eq [System.Windows.Forms.MouseButtons]::Right) -and ($PokemonC -match "Blank")) {
        ...
        $GetPokemonID = $GetPokemonWithIDFromFile -Replace '[^0-9]','' -Replace ' ', ''
        $GetPokemonName = $GetPokemonWithIDFromFile -Replace '[0-9]','' -Replace ' ', ''
        if ($PokemonDexInput) { if ($GetPokemonID | Where-Object { $_ -match "\b$PokemonDexInput\b" }) { $SetConfig = "$PWD\Counter Config Files\CounterConfig_$GetProfile.txt"; $GetConfig = Get-Content $SetConfig; $GetConfig[14] = "Pokemon_C=$GetPokemonID"; $GetConfig[16] = "Pokemon_C_Hover=$GetPokemonName #$GetPokemonID"; $GetConfig | Set-Content -Path $SetConfig; Start-Process "$PWD\ArchetypeCounter.bat" -NoNewWindow -Wait } else { [System.Windows.MessageBox]::Show("No match found for the Pokemon Dex Number. Please ensure you input a correct number value for the specific Pokemon.","Archetype Counter","OK","Asterisk") } }
...
$ArchetypePokeCLabelCount.Location = New-object system.drawing.point(25,191)
...
$ArchetypeBusyImage = New-Object system.windows.Forms.PictureBox
$ArchetypeBusyImage.Image = $ArchetypeBusyFile
$ArchetypeBusyImage.Width = 64
$ArchetypeBusyImage.Height = 18
$ArchetypeBusyImage.Visible = $false
if ($DetectionCount -match "3") { $ArchetypeBusyImage.location = New-object system.drawing.point(15,297) } elseif ($DetectionCount -match "2") { $ArchetypeBusyImage.location = New-object system.drawing.point(15,240) } elseif ($DetectionCount -match "1") { $ArchetypeBusyImage.location = New-object system.drawing.point(15,183) }
$ArchetypeForm.controls.Add($ArchetypeBusyImage)
...
$ArchetypePlayImage.Height = 18
if ($DetectionCount -match "3") { $ArchetypePlayImage.location = New-object system.drawing.point(15,297) } elseif ($DetectionCount -match "2") { $ArchetypePlayImage.location = New-object system.drawing.point(15,240) } elseif ($DetectionCount -match "1") { $ArchetypePlayImage.location = New-object system.drawing.point(15,183) }
...
if ($CounterMode -match "Collapsed_Egg") { $ArchetypeImage.Width = 115; $ArchetypeImage.Height = 38; $ArchetypeImage.Image = $ArchetypeBaseFileCollapsedEgg; $ArchetypeMainOnImage.Visible = $false; $ArchetypeMainOffImage.Visible = $false; $ArchetypeMainEggImage.Visible = $false; $ArchetypeCollapsedCount.Visible = $false; $ArchetypePokeAImage.Visible = $false; $ArchetypePokeALabelCount.Visible = $false; $ArchetypePokeBImage.Visible = $false; $ArchetypePokeBLabelCount.Visible = $false; $ArchetypePokeCImage.Visible = $false; $ArchetypePokeCLabelCount.Visible = $false; $ArchetypePlayImage.Visible = $false; $ArchetypeStopImage.Visible = $false; $ArchetypeResetImage.Visible = $false; $ArchetypeCloseImage.Visible = $false }
...
$ArchetypeImage.Add_MouseDown({
    ...
    if ($_.Button -eq [System.Windows.Forms.MouseButtons]::Right) {
        ...
        $ArchetypeMenuStripToolProfile6 = [System.Drawing.Bitmap]::FromFile("$PWD\GUI Form Images\Icons\Profile6.png")
        $ArchetypeMenuStripToolProfile7 = [System.Drawing.Bitmap]::FromFile("$PWD\GUI Form Images\Icons\Profile7.png")
        $ArchetypeMenuStripToolProfile8 = [System.Drawing.Bitmap]::FromFile("$PWD\GUI Form Images\Icons\Profile8.png")
        $ArchetypeMenuStripToolProfile9 = [System.Drawing.Bitmap]::FromFile("$PWD\GUI Form Images\Icons\Profile9.png")
        $ArchetypeMenuStripToolProfile10 = [System.Drawing.Bitmap]::FromFile("$PWD\GUI Form Images\Icons\Profile10.png")
        ...
        $ArchetypeMenuStripTool6.DropDownItems.Add("Reset Poke Slot 1", $ArchetypeMenuStripToolNumber1).add_Click({ 
        ...
        $ArchetypeMenuStripTool6.DropDownItems.Add("Reset Poke Slot 2", $ArchetypeMenuStripToolNumber2).add_Click({ 
...
Function PlayAction {
        ...
        if ($CounterMode -match "Collapsed_Encounter" -or $CounterMode -match "Collapsed_Egg") { $ArchetypeMainOnImage.Visible = $false; $ArchetypeStopImage.Visible = $false } else { $ArchetypeMainOnImage.Visible = $false; $ArchetypeStopImage.Visible = $true }
            ...
            [GC]::WaitForPendingFinalizers()
                ...
                if ($PokeMMOActive -ne $null) {
                    ...
                    if ($GetPixelColor -match "fffb00fb" -or $GetPixelColor -match "fd00fdff" -or $GetPixelColor -match "f900f9ff" -or $GetPixelColor -match "fb00fbff" -or $GetPixelColor -match "fff900f9" -or $GetPixelColor -match "fffd00fd") {
                        ...
                        $Script:SyncHashTable.ArchetypeStopImage.Visible = $false
                        $Script:SyncHashTable.ArchetypeBusyImage.Visible = $true
                        $Script:SyncHashTable.ArchetypeForm.update()
                        $Script:SyncHashTable.ArchetypeForm.refresh()

                        # Wait
                        Start-Sleep -Milliseconds 2650
                        ...
                        $ImageMagickCall = "$PWD\Counter Functions\ImageMagick\InvokeMagickFilter.bat"
                        Start-Process -WindowStyle hidden $ImageMagickCall -Wait

                        # Loads the OCR module into a variable
                        if ($IgnoreSystemLang -match "True") { $OCRVariable = Convert-PsoImageToText -Path "$PWD\Counter Functions\ImageMagick\ArchetypeScreenshotMagick.png" } else { $OCRVariable = Convert-PsoImageToText -Path "$PWD\Counter Functions\ImageMagick\ArchetypeScreenshotMagick.png" -Language $LangTag; if($?) { } else { $OCRVariable = Convert-PsoImageToText -Path "$PWD\Counter Functions\ImageMagick\ArchetypeScreenshotMagick.png" -Language en } }
                        if ($OCRVariable -eq $null) { $OCRVariable = Convert-PsoImageToText -Path "$PWD\Counter Functions\ImageMagick\ArchetypeScreenshotMagick.png" }
                        $OCRVariable.text; $OCRCaptured = $OCRVariable.text

                        # (WHEN DEBUGGING MODE IS TURN ON!)
                        if ($DebugMode -match "True") { Copy-Item -Path "$PWD\Counter Functions\ImageMagick\ArchetypeScreenshot.png" -Destination "$PWD\Counter Functions\ScreenCapture\DEBUG\ArchetypeScreenshot.png" -Force; Copy-Item -Path "$PWD\Counter Functions\ImageMagick\ArchetypeScreenshotMagick.png" -Destination "$PWD\Counter Functions\ScreenCapture\DEBUG\ArchetypeScreenshotMagick.png" -Force }
                        ...
                        # Special check for Mr Mime/Nidoran/Gastly on OCR check
                        ...
                        # (WHEN DEBUGGING MODE IS TURN ON!)
                        if ($DebugMode -match "True") { $OCRCaptured | Out-File "$PWD\Counter Functions\ScreenCapture\DEBUG\DEBUG_OCR_AfterLogic.txt" }
                        ...
                        if ($CheckForShiny -eq $true -or $CheckForShiny1 -eq $true -or $CheckForShiny2 -eq $true -or $CheckForShiny3 -eq $true) {
                            ...
                            While ($GetPixelColor -match "fffb00fb" -or $GetPixelColor -match "fd00fdff" -or $GetPixelColor -match "f900f9ff" -or $GetPixelColor -match "fb00fbff" -or $GetPixelColor -match "fff900f9") { Start-Process "$PWD\Counter Functions\ScreenCapture\ScreenCapture.ahk" -Wait; $PixelSearchImage = New-Object System.Drawing.Bitmap "$PWD\Counter Functions\ImageMagick\ArchetypeScreenshot.png"; $GetPixelColor = $PixelSearchImage.GetPixel(0,0); $GetPixelColor = ($GetPixelColor).Name; $PixelSearchImage.Dispose() }
                        ...
                        # Checks if same Pokemon has already been seen
                            ...
                            # Refreshes counter and adds +1 on the pokemon scane
                            $Script:SyncHashTable.ArchetypePokeALabelCount.Text = $GetPokeNameACountForm
